...
<%
	...
	String radio_teacher=request.getParameter("radio_teacher");
	String correctAnswer = request.getParameter("correctAnswer");
	
	if(radio_teacher!=null && correctAnswer!=null)
	{
		if(radio_teacher.equals(correctAnswer))
		{
		...
		%>
		<center><input type='button' onclick="location.href='teacher_event.jsp'" value='다음' class="submitBtn"/></center>
