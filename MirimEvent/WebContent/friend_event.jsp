...
<% 
	...
	int randNum = rand.nextInt(19);//0-18
	
	String correct = imgURl.get(randNum);
	String imgSrc ="image/friend/big/"+correct+".jpg";
	String orgin_imgSrc ="image/friend/origin/"+correct+".jpg";
	...
	for(int i=1; i<randRadioNum.length; i++){
		...
		randRadioNum[i]= (int)(Math.random()*19);
...
<form method="post" action="friend_eventResult.jsp">
...
<%
	...
	for(int i=0; i<randRadioNum.length;i++)
	{
		...
		<input type="radio" name="radio_friend" value="<%=radioStr%>"><span class="checkmark"></span>
		</label>
		<%
	}
