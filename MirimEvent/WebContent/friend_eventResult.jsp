...
<%
	...
	String radio_friend=request.getParameter("radio_friend");
	String correctAnswer = request.getParameter("correctAnswer");
	
	if(radio_friend!=null && correctAnswer!=null)
	{
		if(radio_friend.equals(correctAnswer))
		{
		...
		%>
		<center><input type='button' onclick="location.href='friend_event.jsp'" value='다음' class="submitBtn"/></center>
